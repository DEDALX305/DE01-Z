...
int main()
{
	...
	float	TimeFirst, TimeFinal, t_load, Time_j, time_j, N_ProcessingSteps, TALL, t_0, k1;
	float	Size1, Size2, SFastMemory, SMainMemory, MainMemThroughput, FastMemThroughput, PerfParallelAgentManager;
/* -----------------------------Константные переменные---------------------------------*/
	TimeFinal = 1;
	k1 = 2500000;
/*-------------------------------------------------------------------------------------*/
