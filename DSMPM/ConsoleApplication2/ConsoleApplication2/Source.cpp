...
public:
	...
	Manager_of_parallel_agents(float k1, float FastMemThroughputm, float PerfParallelAgentManager, float MainMemThroughput)
	{
		...
		if (PerfParallelAgentManager > 161) 
		{
			k2 = 0,6;
		}
		else 
		...
		ProcRequest = ((k1 / FastMemThroughputm * 700) / PerfParallelAgentManager)*k2;
...
int main()
{
	...
	//*-------------------------------------------------------------------------------------------------*/
	TimeFinal = 1;
	k1 = 2500000; // 7000000000 //25000000
	//*-------------------------------------------------------------------------------------------------*/
