...
public:
	void _calculation()
	{
		float	TimeFirst, TimeFinal, t_load, Time_j, time_j, N_ProcessingSteps, TALL, t_0;
		Memory_manager* memory_manager;
		Manager_of_parallel_agents* manager_of_parallel_agents;
...
{
public: 
	float	TimeFirst, TimeFinal, t_load, Time_j, time_j, N_ProcessingSteps, TALL, t_0, k1, Size1, Size2, SFastMemory, SMainMemory, MainMemThroughput, FastMemThroughput;
	string _Treads_N;
	void Data(float PerfParallelAgentManager)
	{
		/*-------------------------------------------------------------------------------------------------*/
		TimeFinal = 1;
		k1 = 25000000;
...
int main()
{
...
#endif
	float PerfParallelAgentManager;
	string _Treads_N;
	///*-------------------------------------------------------------------------------------------------*/
	//TimeFinal = 1;
	//k1 = 25000000;
	...
	if (_Treads_N == "Y")
	{
		...
		{	
			...
			_InputData->Data(PerfParallelAgentManager);
